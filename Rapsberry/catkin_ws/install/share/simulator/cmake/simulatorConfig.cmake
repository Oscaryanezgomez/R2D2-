...
if("FALSE" STREQUAL "TRUE")
  set(simulator_SOURCE_PREFIX /home/diego/catkin_ws/src/simulator)
  set(simulator_DEVEL_PREFIX /home/diego/catkin_ws/devel)
  ...
  set(simulator_INSTALL_PREFIX /home/diego/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'simulator' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'diego <diego@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'simulator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/diego/catkin_ws/install/${idir}'.  Ask the maintainer 'diego <diego@todo.todo>' to fix it.")
    endif()
